...
const Footer = () => {
    return (
        <footer className="w-full bg-[var(--text-highlight)] text-white py-8 max-lg:hidden">
            <div className="container mx-auto px-4">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                    <div>
                        ...
                        <p className="text-orange-100 text-sm">
                            Connecting businesses with their local audience
                            through innovative TV advertising solutions.
                        </p>
                    </div>
                    <div>
                ...
                <div className="border-t border-orange-400 mt-8 pt-8 text-center text-orange-100">
                    <p>
                        &copy; {new Date().getFullYear()} LocalReach. All rights
                        reserved.
                    </p>
                </div>
            </div>
