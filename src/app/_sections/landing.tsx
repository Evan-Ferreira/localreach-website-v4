...
const Landing = () => {
    return (
        <div className="h-screen w-screen flex flex-row z-100">
            <Background />
            <div className="md:w-2/3 w-full pl-12 max-md:pr-12 md:pl-36 flex flex-col justify-center md:justify-end md:gap-8 gap-24 pb-24">
            ...
            <div className="hidden lg:flex lg:w-1/2 h-full md:pr-36 pr-12 pb-24 flex-row justify-end items-end">
                <VenueScrollBar />
            </div>
        </div>
    );
