        ...
        <div className="h-screen w-screen flex flex-row z-100">
            ...
            <div className="flex justify-end max-lg:justify-center flex-col">
                <div className="max-h-3/4 w-full pl-12 max-md:pr-12 md:pl-36 flex flex-col gap-4 pb-24">
                    <div className="relative w-full mb-7 max-lg:mt-64">
                        <AnimationLoader
                            direction="right"
                            duration={0.5}
                            type="tween"
                        >
                            <div
                                className="bg-[#FD6F2F] lg:w-63 lg:h-32 h-18 w-37 absolute lg:-top-15 -top-7.5
                    ...
                    <AnimationLoader
                        ...
                        type="tween"
                    >
                        <div className="flex mb-3 flex-col text-sm  md:flex-row md:gap-2 max-lg:hidden">
                            <p className="w-full md:w-[30%] opacity-70 max-md:text-center">
                                <span className="opacity-70">
                                    Engage your audience with content they care
                                    about.
                                </span>
                                <a
                                    href="#blog"
                                    className="inline-block text-white opacity-100 hover:opacity-80 transition-colors"
                                >
                                    Learn more
                                </a>
                            </p>
                            <p className="w-full md:w-[30%] opacity-70 max-md:text-center">
                                <span className="opacity-70">
                                    Connect with restaurants for innovative
            ...
            <div className="absolute bottom-0 left-0 w-full mb-10 text-white py-3 text-center opacity-30 px-12">
                <p className="text-xs">
                    As of 11th April 2025, LocalReach is now part of TAIV. For
