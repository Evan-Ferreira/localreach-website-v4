...
const blogPosts: BlogPost[] = [
    {
        ...
        date: "March 15, 2024",
        imageUrl: "/blog/tv-advertising.jpg"
    },
    {
        id: 2,
        title: "Maximizing Local Business Reach",
        excerpt: "Learn effective strategies for connecting with your community through targeted advertising...",
        date: "March 10, 2024", 
        imageUrl: "/blog/local-business.jpg"
    },
    {
        id: 3,
        title: "Digital Marketing Trends 2024",
        excerpt: "Stay ahead of the curve with the latest developments in digital marketing and advertising...",
        date: "March 5, 2024",
        imageUrl: "/blog/digital-trends.jpg"
    }
];
        ...
        <div className="w-full min-h-screen bg-[var(--background)] py-16 px-36 ">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8  relative z-100">
                {blogPosts.map((post) => (
                    <div 
                        key={post.id} 
                        className="bg-[#2121218f] rounded-lg overflow-hidden hover:transform hover:scale-105 transition-all duration-300"
                    >
                        <Image 
                            src={post.imageUrl} 
                            alt={post.title}
